...
export const translations = {
  pt: {
    ...
    common: {
      ...
      viewItemDetails: "Ver detalhes do item",
      less: "Menos",
      more: "Mais",
      quantity: "Quantidade",
      remove: "Remover",
      ...
      progressToNextTier: "Progresso para próximo tier",
      you: "Você",
      yes: "Sim",
      no: "Não",
    },
    ...
    trade: {
      chatLabel: "Chat da troca",
      messages: "Mensagens",
      sendMessage: "Enviar mensagem",
      messagePlaceholder: "Mensagem…",
      messageLabel: "Texto da mensagem",
      send: "Enviar",
      noMessagesYet: "Nenhuma mensagem ainda. Combine o encontro no jogo aqui.",
    },
    admin: {
      disputeStatusOpen: "Aberta",
      disputeStatusUnderReview: "Em análise",
      disputeStatusResolved: "Resolvida",
      disputeStatusClosed: "Encerrada",
      adminNotesLabel: "Notas (visíveis apenas para admin)",
      adminNotesPlaceholder: "Registo interno da resolução...",
      deactivateItem: "Desativar item",
      activateItem: "Ativar item",
      navLabel: "Admin",
    },
    analytics: {
      ...
      sectionLabel: "Preços da última semana",
    },
    itemDetail: {
  ...
  en: {
    ...
    trade: {
      chatLabel: "Trade chat",
      messages: "Messages",
      sendMessage: "Send message",
      messagePlaceholder: "Message…",
      messageLabel: "Message text",
      send: "Send",
      noMessagesYet: "No messages yet. Arrange the in-game meetup here.",
    },
    admin: {
      ...
      adminNotesLabel: "Notes (visible to admins only)",
      adminNotesPlaceholder: "Internal resolution notes...",
...
export function t(locale: Locale, key: string, params?: Record<string, string | number>): string {
  ...
  if (value == null) return getNested(translations.en as Record<string, unknown>, key) ?? key;
